	...
	fromJSON(object: any): FileDescriptorProto {
		...
		message.package =
			object.package !== undefined && object.package !== null
				...
				: '';
		message.dependency = (object.dependency ?? []).map((e: any) =>
			String(e)
		);
		message.publicDependency = (object.publicDependency ?? []).map(
			(e: any) => Number(e)
		);
...
export const FieldDescriptorProto = {
	...
	fromJSON(object: any): FieldDescriptorProto {
		...
		message.proto3Optional =
			object.proto3Optional !== undefined &&
			object.proto3Optional !== null
...
export const FileOptions = {
	...
	fromJSON(object: any): FileOptions {
		...
		message.ccEnableArenas =
			object.ccEnableArenas !== undefined &&
		...
		message.phpClassPrefix =
			object.phpClassPrefix !== undefined &&
			object.phpClassPrefix !== null
...
export const UninterpretedOption = {
	...
	fromJSON(object: any): UninterpretedOption {
		...
		message.aggregateValue =
			object.aggregateValue !== undefined &&
