...
const baseTxResponse: object = { height: Long.ZERO,txhash: "",codespace: "",code: 0,data: "",rawLog: "",info: "",gasWanted: Long.ZERO,gasUsed: Long.ZERO,timestamp: "" };
...
message.height = (object.height !== undefined && object.height !== null)
          ...
          : Long.ZERO;
message.txhash = (object.txhash !== undefined && object.txhash !== null)
...
message.data = (object.data !== undefined && object.data !== null)
          ? String(object.data)
          : "";
message.rawLog = (object.rawLog !== undefined && object.rawLog !== null)
...
fromJSON(object: any): MsgData {
      const message = { ...baseMsgData } as MsgData;
message.msgType = (object.msgType !== undefined && object.msgType !== null)
...
const baseSearchTxsResult: object = { totalCount: Long.UZERO,count: Long.UZERO,pageNumber: Long.UZERO,pageTotal: Long.UZERO,limit: Long.UZERO };
