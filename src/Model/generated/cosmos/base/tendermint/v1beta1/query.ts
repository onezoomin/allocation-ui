...
message.name = (object.name !== undefined && object.name !== null)
          ? String(object.name)
          : "";
message.appName = (object.appName !== undefined && object.appName !== null)
          ? String(object.appName)
          : "";
message.version = (object.version !== undefined && object.version !== null)
          ? String(object.version)
          : "";
message.gitCommit = (object.gitCommit !== undefined && object.gitCommit !== null)
          ? String(object.gitCommit)
          : "";
message.buildTags = (object.buildTags !== undefined && object.buildTags !== null)
          ? String(object.buildTags)
          : "";
message.goVersion = (object.goVersion !== undefined && object.goVersion !== null)
...
export class ServiceClientImpl implements Service {private readonly rpc: Rpc;constructor(rpc: Rpc) {this.rpc = rpc;this.GetNodeInfo = this.GetNodeInfo.bind(this);this.GetSyncing = this.GetSyncing.bind(this);this.GetLatestBlock = this.GetLatestBlock.bind(this);this.GetBlockByHeight = this.GetBlockByHeight.bind(this);this.GetLatestValidatorSet = this.GetLatestValidatorSet.bind(this);this.GetValidatorSetByHeight = this.GetValidatorSetByHeight.bind(this);}
    GetNodeInfo(
