...
message.content = (object.content !== undefined && object.content !== null)
          ...
          : undefined;
message.initialDeposit = (object.initialDeposit ?? []).map((e: any) => Coin.fromJSON(e));
...
export class MsgClientImpl implements Msg {private readonly rpc: Rpc;constructor(rpc: Rpc) {this.rpc = rpc;this.SubmitProposal = this.SubmitProposal.bind(this);this.Vote = this.Vote.bind(this);this.Deposit = this.Deposit.bind(this);}
    SubmitProposal(
