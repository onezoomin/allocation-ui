...
fromJSON(object: any): QueryProposalsRequest {
      const message = { ...baseQueryProposalsRequest } as QueryProposalsRequest;
message.proposalStatus = (object.proposalStatus !== undefined && object.proposalStatus !== null)
...
fromJSON(object: any): QueryParamsRequest {
      const message = { ...baseQueryParamsRequest } as QueryParamsRequest;
message.paramsType = (object.paramsType !== undefined && object.paramsType !== null)
...
export class QueryClientImpl implements Query {private readonly rpc: Rpc;constructor(rpc: Rpc) {this.rpc = rpc;this.Proposal = this.Proposal.bind(this);this.Proposals = this.Proposals.bind(this);this.Vote = this.Vote.bind(this);this.Votes = this.Votes.bind(this);this.Params = this.Params.bind(this);this.Deposit = this.Deposit.bind(this);this.Deposits = this.Deposits.bind(this);this.TallyResult = this.TallyResult.bind(this);}
    Proposal(
