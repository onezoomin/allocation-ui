...
switch (object) {
case VoteOption.VOTE_OPTION_UNSPECIFIED: return "VOTE_OPTION_UNSPECIFIED";
case VoteOption.VOTE_OPTION_YES: return "VOTE_OPTION_YES";
case VoteOption.VOTE_OPTION_ABSTAIN: return "VOTE_OPTION_ABSTAIN";
case VoteOption.VOTE_OPTION_NO: return "VOTE_OPTION_NO";
case VoteOption.VOTE_OPTION_NO_WITH_VETO: return "VOTE_OPTION_NO_WITH_VETO";
...
case ProposalStatus.PROPOSAL_STATUS_DEPOSIT_PERIOD: return "PROPOSAL_STATUS_DEPOSIT_PERIOD";
case ProposalStatus.PROPOSAL_STATUS_VOTING_PERIOD: return "PROPOSAL_STATUS_VOTING_PERIOD";
case ProposalStatus.PROPOSAL_STATUS_PASSED: return "PROPOSAL_STATUS_PASSED";
case ProposalStatus.PROPOSAL_STATUS_REJECTED: return "PROPOSAL_STATUS_REJECTED";
case ProposalStatus.PROPOSAL_STATUS_FAILED: return "PROPOSAL_STATUS_FAILED";
default: return "UNKNOWN";
}
}
...
message.finalTallyResult = (object.finalTallyResult !== undefined && object.finalTallyResult !== null)
          ...
          : undefined;
message.submitTime = (object.submitTime !== undefined && object.submitTime !== null)
          ? fromJsonTimestamp(object.submitTime)
          : undefined;
message.depositEndTime = (object.depositEndTime !== undefined && object.depositEndTime !== null)
          ? fromJsonTimestamp(object.depositEndTime)
          : undefined;
message.totalDeposit = (object.totalDeposit ?? []).map((e: any) => Coin.fromJSON(e));
message.votingStartTime = (object.votingStartTime !== undefined && object.votingStartTime !== null)
          ? fromJsonTimestamp(object.votingStartTime)
          : undefined;
message.votingEndTime = (object.votingEndTime !== undefined && object.votingEndTime !== null)
...
fromJSON(object: any): TallyResult {
      const message = { ...baseTallyResult } as TallyResult;
message.yes = (object.yes !== undefined && object.yes !== null)
          ? String(object.yes)
          : "";
message.abstain = (object.abstain !== undefined && object.abstain !== null)
          ? String(object.abstain)
          : "";
message.no = (object.no !== undefined && object.no !== null)
          ? String(object.no)
          : "";
message.noWithVeto = (object.noWithVeto !== undefined && object.noWithVeto !== null)
...
message.threshold = (object.threshold !== undefined && object.threshold !== null)
          ...
          : new Uint8Array();
message.vetoThreshold = (object.vetoThreshold !== undefined && object.vetoThreshold !== null)
