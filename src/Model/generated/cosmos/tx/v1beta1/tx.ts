...
message.bodyBytes = (object.bodyBytes !== undefined && object.bodyBytes !== null)
          ...
          : new Uint8Array();
message.authInfoBytes = (object.authInfoBytes !== undefined && object.authInfoBytes !== null)
...
message.bitarray = (object.bitarray !== undefined && object.bitarray !== null)
          ...
          : undefined;
message.modeInfos = (object.modeInfos ?? []).map((e: any) => ModeInfo.fromJSON(e));
return message
},
...
message.payer = (object.payer !== undefined && object.payer !== null)
          ? String(object.payer)
          : "";
message.granter = (object.granter !== undefined && object.granter !== null)
