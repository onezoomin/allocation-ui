...
message.delegatorAddress = (object.delegatorAddress !== undefined && object.delegatorAddress !== null)
          ...
          : "";
message.withdrawAddress = (object.withdrawAddress !== undefined && object.withdrawAddress !== null)
...
message.validatorAddress = (object.validatorAddress !== undefined && object.validatorAddress !== null)
          ...
          : "";
message.outstandingRewards = (object.outstandingRewards ?? []).map((e: any) => DecCoin.fromJSON(e));
return message
},
...
const baseValidatorSlashEventRecord: object = { validatorAddress: "",height: Long.UZERO,period: Long.UZERO };
...
message.feePool = (object.feePool !== undefined && object.feePool !== null)
          ...
          : undefined;
message.delegatorWithdrawInfos = (object.delegatorWithdrawInfos ?? []).map((e: any) => DelegatorWithdrawInfo.fromJSON(e));
message.previousProposer = (object.previousProposer !== undefined && object.previousProposer !== null)
          ? String(object.previousProposer)
          : "";
message.outstandingRewards = (object.outstandingRewards ?? []).map((e: any) => ValidatorOutstandingRewardsRecord.fromJSON(e));
message.validatorAccumulatedCommissions = (object.validatorAccumulatedCommissions ?? []).map((e: any) => ValidatorAccumulatedCommissionRecord.fromJSON(e));
message.validatorHistoricalRewards = (object.validatorHistoricalRewards ?? []).map((e: any) => ValidatorHistoricalRewardsRecord.fromJSON(e));
message.validatorCurrentRewards = (object.validatorCurrentRewards ?? []).map((e: any) => ValidatorCurrentRewardsRecord.fromJSON(e));
message.delegatorStartingInfos = (object.delegatorStartingInfos ?? []).map((e: any) => DelegatorStartingInfoRecord.fromJSON(e));
message.validatorSlashEvents = (object.validatorSlashEvents ?? []).map((e: any) => ValidatorSlashEventRecord.fromJSON(e));
return message
},
