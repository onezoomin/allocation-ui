...
const baseQueryValidatorSlashesRequest: object = { validatorAddress: "",startingHeight: Long.UZERO,endingHeight: Long.UZERO };
...
fromJSON(object: any): QueryValidatorSlashesResponse {
      const message = { ...baseQueryValidatorSlashesResponse } as QueryValidatorSlashesResponse;
message.slashes = (object.slashes ?? []).map((e: any) => ValidatorSlashEvent.fromJSON(e));
message.pagination = (object.pagination !== undefined && object.pagination !== null)
...
fromJSON(object: any): QueryDelegationTotalRewardsResponse {
      const message = { ...baseQueryDelegationTotalRewardsResponse } as QueryDelegationTotalRewardsResponse;
message.rewards = (object.rewards ?? []).map((e: any) => DelegationDelegatorReward.fromJSON(e));
...
export class QueryClientImpl implements Query {private readonly rpc: Rpc;constructor(rpc: Rpc) {this.rpc = rpc;this.Params = this.Params.bind(this);this.ValidatorOutstandingRewards = this.ValidatorOutstandingRewards.bind(this);this.ValidatorCommission = this.ValidatorCommission.bind(this);this.ValidatorSlashes = this.ValidatorSlashes.bind(this);this.DelegationRewards = this.DelegationRewards.bind(this);this.DelegationTotalRewards = this.DelegationTotalRewards.bind(this);this.DelegatorValidators = this.DelegatorValidators.bind(this);this.DelegatorWithdrawAddress = this.DelegatorWithdrawAddress.bind(this);this.CommunityPool = this.CommunityPool.bind(this);}
    Params(
