...
fromJSON(object: any): QuerySigningInfoRequest {
      const message = { ...baseQuerySigningInfoRequest } as QuerySigningInfoRequest;
message.consAddress = (object.consAddress !== undefined && object.consAddress !== null)
...
fromJSON(object: any): QuerySigningInfosResponse {
      const message = { ...baseQuerySigningInfosResponse } as QuerySigningInfosResponse;
message.info = (object.info ?? []).map((e: any) => ValidatorSigningInfo.fromJSON(e));
message.pagination = (object.pagination !== undefined && object.pagination !== null)
...
export class QueryClientImpl implements Query {private readonly rpc: Rpc;constructor(rpc: Rpc) {this.rpc = rpc;this.Params = this.Params.bind(this);this.SigningInfo = this.SigningInfo.bind(this);this.SigningInfos = this.SigningInfos.bind(this);}
    Params(
