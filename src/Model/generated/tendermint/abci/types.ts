...
switch (object) {
case EvidenceType.UNKNOWN: return "UNKNOWN";
case EvidenceType.DUPLICATE_VOTE: return "DUPLICATE_VOTE";
case EvidenceType.LIGHT_CLIENT_ATTACK: return "LIGHT_CLIENT_ATTACK";
default: return "UNKNOWN";
}
}
...
message.appStateBytes = (object.appStateBytes !== undefined && object.appStateBytes !== null)
...
message.height = (object.height !== undefined && object.height !== null)
          ...
          : Long.ZERO;
message.prove = (object.prove !== undefined && object.prove !== null)
...
message.lastCommitInfo = (object.lastCommitInfo !== undefined && object.lastCommitInfo !== null)
          ...
          : undefined;
message.byzantineValidators = (object.byzantineValidators ?? []).map((e: any) => Evidence.fromJSON(e));
return message
},
...
message.snapshot = (object.snapshot !== undefined && object.snapshot !== null)
          ...
          : undefined;
message.appHash = (object.appHash !== undefined && object.appHash !== null)
...
const baseResponseInfo: object = { data: "",version: "",appVersion: Long.UZERO,lastBlockHeight: Long.ZERO };
...
message.lastBlockHeight = (object.lastBlockHeight !== undefined && object.lastBlockHeight !== null)
          ...
          : Long.ZERO;
message.lastBlockAppHash = (object.lastBlockAppHash !== undefined && object.lastBlockAppHash !== null)
...
const baseResponseQuery: object = { code: 0,log: "",info: "",index: Long.ZERO,height: Long.ZERO,codespace: "" };
...
message.height = (object.height !== undefined && object.height !== null)
          ? Long.fromString(object.height)
          : Long.ZERO;
message.codespace = (object.codespace !== undefined && object.codespace !== null)
...
message.info = (object.info !== undefined && object.info !== null)
          ? String(object.info)
          : "";
message.gasWanted = (object.gas_wanted !== undefined && object.gas_wanted !== null)
          ? Long.fromString(object.gas_wanted)
          : Long.ZERO;
message.gasUsed = (object.gas_used !== undefined && object.gas_used !== null)
...
const baseResponseDeliverTx: object = { code: 0,log: "",info: "",gasWanted: Long.ZERO,gasUsed: Long.ZERO,codespace: "" };
...
fromJSON(object: any): ResponseEndBlock {
      const message = { ...baseResponseEndBlock } as ResponseEndBlock;
message.validatorUpdates = (object.validatorUpdates ?? []).map((e: any) => ValidatorUpdate.fromJSON(e));
message.consensusParamUpdates = (object.consensusParamUpdates !== undefined && object.consensusParamUpdates !== null)
...
message.validator = (object.validator !== undefined && object.validator !== null)
          ...
          : undefined;
message.signedLastBlock = (object.signedLastBlock !== undefined && object.signedLastBlock !== null)
