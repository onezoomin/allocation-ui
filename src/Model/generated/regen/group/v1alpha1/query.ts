...
export const QueryGroupAccountInfoResponse = {
	...
	decode(
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				case 1:
					message.info = GroupAccountInfo.decode(
						reader,
						reader.uint32()
					);
					break;
...
export const QueryVoteByProposalVoterRequest = {
	...
	fromPartial<
		I extends Exact<DeepPartial<QueryVoteByProposalVoterRequest>, I>
	>(object: I): QueryVoteByProposalVoterRequest {
		const message = {
			...baseQueryVoteByProposalVoterRequest,
		} as QueryVoteByProposalVoterRequest;
		message.proposalId =
...
export class QueryClientImpl implements Query {
	...
	GroupAccountInfo(
		...
		return promise.then((data) =>
			QueryGroupAccountInfoResponse.decode(new Reader(data))
		);
	}
	...
	GroupAccountsByGroup(
		...
		return promise.then((data) =>
			QueryGroupAccountsByGroupResponse.decode(new Reader(data))
		);
	}
	...
	GroupAccountsByAdmin(
		...
		return promise.then((data) =>
			QueryGroupAccountsByAdminResponse.decode(new Reader(data))
		);
	}
	...
	ProposalsByGroupAccount(
		...
		const data =
			QueryProposalsByGroupAccountRequest.encode(request).finish();
		const promise = this.rpc.request(
			'regen.group.v1alpha1.Query',
			'ProposalsByGroupAccount',
			data
		...
		return promise.then((data) =>
			QueryProposalsByGroupAccountResponse.decode(new Reader(data))
		);
	}
