...
import { GroupInfo, GroupAccountInfo, Proposal, Vote, GroupMember } from '../../../regen/group/v1alpha1/types';
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryGroupAccountInfoRequest } as QueryGroupAccountInfoRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QueryGroupAccountInfoRequest>, I>>(object: I): QueryGroupAccountInfoRequest {
      const message = { ...baseQueryGroupAccountInfoRequest } as QueryGroupAccountInfoRequest;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryGroupAccountInfoResponse } as QueryGroupAccountInfoResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QueryGroupAccountInfoResponse>, I>>(object: I): QueryGroupAccountInfoResponse {
      const message = { ...baseQueryGroupAccountInfoResponse } as QueryGroupAccountInfoResponse;
message.info = (object.info !== undefined && object.info !== null)
...
fromJSON(object: any): QueryGroupsByAdminResponse {
      const message = { ...baseQueryGroupsByAdminResponse } as QueryGroupsByAdminResponse;
message.groups = (object.groups ?? []).map((e: any) => GroupInfo.fromJSON(e));
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromJSON(object.pagination)
          : undefined;
return message
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryGroupAccountsByGroupRequest } as QueryGroupAccountsByGroupRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QueryGroupAccountsByGroupRequest>, I>>(object: I): QueryGroupAccountsByGroupRequest {
      const message = { ...baseQueryGroupAccountsByGroupRequest } as QueryGroupAccountsByGroupRequest;
message.groupId = (object.groupId !== undefined && object.groupId !== null)
          ? Long.fromValue(object.groupId)
          : Long.UZERO;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryGroupAccountsByGroupResponse } as QueryGroupAccountsByGroupResponse;
...
fromJSON(object: any): QueryGroupAccountsByGroupResponse {
      const message = { ...baseQueryGroupAccountsByGroupResponse } as QueryGroupAccountsByGroupResponse;
message.groupAccounts = (object.groupAccounts ?? []).map((e: any) => GroupAccountInfo.fromJSON(e));
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromJSON(object.pagination)
          : undefined;
return message
...
fromPartial<I extends Exact<DeepPartial<QueryGroupAccountsByGroupResponse>, I>>(object: I): QueryGroupAccountsByGroupResponse {
      const message = { ...baseQueryGroupAccountsByGroupResponse } as QueryGroupAccountsByGroupResponse;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryGroupAccountsByAdminRequest } as QueryGroupAccountsByAdminRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QueryGroupAccountsByAdminRequest>, I>>(object: I): QueryGroupAccountsByAdminRequest {
      const message = { ...baseQueryGroupAccountsByAdminRequest } as QueryGroupAccountsByAdminRequest;
message.admin = object.admin ?? "";
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageRequest.fromPartial(object.pagination)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryGroupAccountsByAdminResponse } as QueryGroupAccountsByAdminResponse;
message.groupAccounts = [];
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
fromPartial<I extends Exact<DeepPartial<QueryGroupAccountsByAdminResponse>, I>>(object: I): QueryGroupAccountsByAdminResponse {
      const message = { ...baseQueryGroupAccountsByAdminResponse } as QueryGroupAccountsByAdminResponse;
message.groupAccounts = object.groupAccounts?.map((e) => GroupAccountInfo.fromPartial(e)) || [];
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromPartial(object.pagination)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryProposalsByGroupAccountRequest } as QueryProposalsByGroupAccountRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QueryProposalsByGroupAccountRequest>, I>>(object: I): QueryProposalsByGroupAccountRequest {
      const message = { ...baseQueryProposalsByGroupAccountRequest } as QueryProposalsByGroupAccountRequest;
message.address = object.address ?? "";
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageRequest.fromPartial(object.pagination)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryProposalsByGroupAccountResponse } as QueryProposalsByGroupAccountResponse;
message.proposals = [];
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
fromPartial<I extends Exact<DeepPartial<QueryProposalsByGroupAccountResponse>, I>>(object: I): QueryProposalsByGroupAccountResponse {
      const message = { ...baseQueryProposalsByGroupAccountResponse } as QueryProposalsByGroupAccountResponse;
...
export class QueryClientImpl implements Query {private readonly rpc: Rpc;constructor(rpc: Rpc) {this.rpc = rpc;this.GroupInfo = this.GroupInfo.bind(this);this.GroupAccountInfo = this.GroupAccountInfo.bind(this);this.GroupMembers = this.GroupMembers.bind(this);this.GroupsByAdmin = this.GroupsByAdmin.bind(this);this.GroupAccountsByGroup = this.GroupAccountsByGroup.bind(this);this.GroupAccountsByAdmin = this.GroupAccountsByAdmin.bind(this);this.Proposal = this.Proposal.bind(this);this.ProposalsByGroupAccount = this.ProposalsByGroupAccount.bind(this);this.VoteByProposalVoter = this.VoteByProposalVoter.bind(this);this.VotesByProposal = this.VotesByProposal.bind(this);this.VotesByVoter = this.VotesByVoter.bind(this);}
    GroupInfo(
      ...
      return promise.then(data => QueryGroupInfoResponse.decode(new Reader(data)));
    }
    ...
    GroupAccountInfo(
      ...
      return promise.then(data => QueryGroupAccountInfoResponse.decode(new Reader(data)));
    }
    ...
    GroupMembers(
      ...
      return promise.then(data => QueryGroupMembersResponse.decode(new Reader(data)));
    }
    ...
    GroupsByAdmin(
      ...
      return promise.then(data => QueryGroupsByAdminResponse.decode(new Reader(data)));
    }
    ...
    GroupAccountsByGroup(
      ...
      return promise.then(data => QueryGroupAccountsByGroupResponse.decode(new Reader(data)));
    }
    ...
    GroupAccountsByAdmin(
      ...
      return promise.then(data => QueryGroupAccountsByAdminResponse.decode(new Reader(data)));
    }
    ...
    ProposalsByGroupAccount(
      ...
      return promise.then(data => QueryProposalsByGroupAccountResponse.decode(new Reader(data)));
    }
    ...
    VoteByProposalVoter(
      ...
      return promise.then(data => QueryVoteByProposalVoterResponse.decode(new Reader(data)));
    }
    ...
    VotesByProposal(
      ...
      return promise.then(data => QueryVotesByProposalResponse.decode(new Reader(data)));
    }
    ...
    VotesByVoter(
      ...
      return promise.then(data => QueryVotesByVoterResponse.decode(new Reader(data)));
    }
  }
