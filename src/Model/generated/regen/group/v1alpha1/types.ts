...
switch (object) {
case Choice.CHOICE_UNSPECIFIED: return "CHOICE_UNSPECIFIED";
case Choice.CHOICE_NO: return "CHOICE_NO";
case Choice.CHOICE_YES: return "CHOICE_YES";
case Choice.CHOICE_ABSTAIN: return "CHOICE_ABSTAIN";
case Choice.CHOICE_VETO: return "CHOICE_VETO";
...
switch (object) {
case Proposal_Status.STATUS_UNSPECIFIED: return "STATUS_UNSPECIFIED";
case Proposal_Status.STATUS_SUBMITTED: return "STATUS_SUBMITTED";
case Proposal_Status.STATUS_CLOSED: return "STATUS_CLOSED";
case Proposal_Status.STATUS_ABORTED: return "STATUS_ABORTED";
default: return "UNKNOWN";
}
}
...
switch (object) {
case Proposal_Result.RESULT_UNSPECIFIED: return "RESULT_UNSPECIFIED";
case Proposal_Result.RESULT_UNFINALIZED: return "RESULT_UNFINALIZED";
case Proposal_Result.RESULT_ACCEPTED: return "RESULT_ACCEPTED";
case Proposal_Result.RESULT_REJECTED: return "RESULT_REJECTED";
default: return "UNKNOWN";
}
}
...
switch (object) {
case Proposal_ExecutorResult.EXECUTOR_RESULT_UNSPECIFIED: return "EXECUTOR_RESULT_UNSPECIFIED";
case Proposal_ExecutorResult.EXECUTOR_RESULT_NOT_RUN: return "EXECUTOR_RESULT_NOT_RUN";
case Proposal_ExecutorResult.EXECUTOR_RESULT_SUCCESS: return "EXECUTOR_RESULT_SUCCESS";
case Proposal_ExecutorResult.EXECUTOR_RESULT_FAILURE: return "EXECUTOR_RESULT_FAILURE";
default: return "UNKNOWN";
}
}
...
message.version = (object.version !== undefined && object.version !== null)
          ...
          : Long.UZERO;
message.totalWeight = (object.totalWeight !== undefined && object.totalWeight !== null)
...
const baseGroupAccountInfo: object = { address: "",groupId: Long.UZERO,admin: "",version: Long.UZERO };
...
message.decisionPolicy = (object.decisionPolicy !== undefined && object.decisionPolicy !== null)
          ...
          : undefined;
message.derivationKey = (object.derivationKey !== undefined && object.derivationKey !== null)
...
fromPartial<I extends Exact<DeepPartial<GroupAccountInfo>, I>>(object: I): GroupAccountInfo {
      const message = { ...baseGroupAccountInfo } as GroupAccountInfo;
message.address = object.address ?? "";
message.groupId = (object.groupId !== undefined && object.groupId !== null)
          ? Long.fromValue(object.groupId)
...
const baseProposal: object = { proposalId: Long.UZERO,address: "",proposers: "",groupVersion: Long.UZERO,groupAccountVersion: Long.UZERO,status: 0,result: 0,executorResult: 0 };
...
message.timeout = (object.timeout !== undefined && object.timeout !== null)
          ...
          : undefined;
message.executorResult = (object.executorResult !== undefined && object.executorResult !== null)
...
fromJSON(object: any): Tally {
      const message = { ...baseTally } as Tally;
message.yesCount = (object.yesCount !== undefined && object.yesCount !== null)
          ? String(object.yesCount)
          : "";
message.noCount = (object.noCount !== undefined && object.noCount !== null)
...
message.abstainCount = (object.abstainCount !== undefined && object.abstainCount !== null)
          ...
          : "";
message.vetoCount = (object.vetoCount !== undefined && object.vetoCount !== null)
