...
export const MsgCreateGroup = {
			...
			switch (tag >>> 3) {
				...
				case 2:
					message.members.push(
						Member.decode(reader, reader.uint32())
					);
					break;
				case 3:
	...
	fromPartial<I extends Exact<DeepPartial<MsgCreateGroup>, I>>(
		...
		message.members =
			object.members?.map((e) => Member.fromPartial(e)) || [];
...
export const MsgUpdateGroupMetadataResponse = {
	...
	fromPartial<
		I extends Exact<DeepPartial<MsgUpdateGroupMetadataResponse>, I>
	>(_: I): MsgUpdateGroupMetadataResponse {
		const message = {
			...baseMsgUpdateGroupMetadataResponse,
		} as MsgUpdateGroupMetadataResponse;
		return message;
		...
		while (reader.pos < end) {
			...
			switch (tag >>> 3) {
				...
				case 3:
					...
					break;
				case 4:
					message.decisionPolicy = Any.decode(
						reader,
						reader.uint32()
					);
					break;
	...
	fromJSON(object: any): MsgCreateGroupAccount {
		...
		message.metadata =
			object.metadata !== undefined && object.metadata !== null
				...
				: new Uint8Array();
		message.decisionPolicy =
			object.decisionPolicy !== undefined &&
			object.decisionPolicy !== null
...
export const MsgVote = {
	...
	toJSON(message: MsgVote): unknown {
		...
		message.choice !== undefined &&
			(obj.choice = choiceToJSON(message.choice));
		message.metadata !== undefined &&
			(obj.metadata = base64FromBytes(
				message.metadata !== undefined
					? message.metadata
...
export class MsgClientImpl implements Msg {
	...
	UpdateGroupAccountDecisionPolicy(
		...
		const data =
			MsgUpdateGroupAccountDecisionPolicy.encode(request).finish();
		const promise = this.rpc.request(
			'regen.group.v1alpha1.Msg',
			'UpdateGroupAccountDecisionPolicy',
			data
