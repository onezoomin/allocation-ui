...
import { Choice, Member, choiceFromJSON, choiceToJSON } from '../../../regen/group/v1alpha1/types';
...
switch (object) {
case Exec.EXEC_UNSPECIFIED: return "EXEC_UNSPECIFIED";
case Exec.EXEC_TRY: return "EXEC_TRY";
...
message.admin = (object.admin !== undefined && object.admin !== null)
          ? String(object.admin)
          : "";
message.members = (object.members ?? []).map((e: any) => Member.fromJSON(e));
...
message.groupId = (object.groupId !== undefined && object.groupId !== null)
          ? Long.fromString(object.groupId)
          : Long.UZERO;
message.memberUpdates = (object.memberUpdates ?? []).map((e: any) => Member.fromJSON(e));
return message
},
...
fromPartial<I extends Exact<DeepPartial<MsgCreateGroupAccount>, I>>(object: I): MsgCreateGroupAccount {
      const message = { ...baseMsgCreateGroupAccount } as MsgCreateGroupAccount;
message.admin = object.admin ?? "";
message.groupId = (object.groupId !== undefined && object.groupId !== null)
          ? Long.fromValue(object.groupId)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgCreateGroupAccountResponse } as MsgCreateGroupAccountResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<MsgCreateGroupAccountResponse>, I>>(object: I): MsgCreateGroupAccountResponse {
      const message = { ...baseMsgCreateGroupAccountResponse } as MsgCreateGroupAccountResponse;
...
const baseMsgUpdateGroupAccountAdmin: object = { admin: "",address: "",newAdmin: "" };
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateGroupAccountAdmin } as MsgUpdateGroupAccountAdmin;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<MsgUpdateGroupAccountAdmin>, I>>(object: I): MsgUpdateGroupAccountAdmin {
      const message = { ...baseMsgUpdateGroupAccountAdmin } as MsgUpdateGroupAccountAdmin;
message.admin = object.admin ?? "";
message.address = object.address ?? "";
message.newAdmin = object.newAdmin ?? "";
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateGroupAccountAdminResponse } as MsgUpdateGroupAccountAdminResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
default:
...
fromPartial<I extends Exact<DeepPartial<MsgUpdateGroupAccountAdminResponse>, I>>(_: I): MsgUpdateGroupAccountAdminResponse {
      const message = { ...baseMsgUpdateGroupAccountAdminResponse } as MsgUpdateGroupAccountAdminResponse;
return message;
}
          };

const baseMsgUpdateGroupAccountDecisionPolicy: object = { admin: "",address: "" };
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateGroupAccountDecisionPolicy } as MsgUpdateGroupAccountDecisionPolicy;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<MsgUpdateGroupAccountDecisionPolicy>, I>>(object: I): MsgUpdateGroupAccountDecisionPolicy {
      const message = { ...baseMsgUpdateGroupAccountDecisionPolicy } as MsgUpdateGroupAccountDecisionPolicy;
message.admin = object.admin ?? "";
message.address = object.address ?? "";
message.decisionPolicy = (object.decisionPolicy !== undefined && object.decisionPolicy !== null)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateGroupAccountDecisionPolicyResponse } as MsgUpdateGroupAccountDecisionPolicyResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
default:
...
fromPartial<I extends Exact<DeepPartial<MsgUpdateGroupAccountDecisionPolicyResponse>, I>>(_: I): MsgUpdateGroupAccountDecisionPolicyResponse {
      const message = { ...baseMsgUpdateGroupAccountDecisionPolicyResponse } as MsgUpdateGroupAccountDecisionPolicyResponse;
return message;
}
          };
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateGroupAccountMetadata } as MsgUpdateGroupAccountMetadata;
message.metadata = new Uint8Array();
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
fromPartial<I extends Exact<DeepPartial<MsgUpdateGroupAccountMetadata>, I>>(object: I): MsgUpdateGroupAccountMetadata {
      const message = { ...baseMsgUpdateGroupAccountMetadata } as MsgUpdateGroupAccountMetadata;
message.admin = object.admin ?? "";
message.address = object.address ?? "";
message.metadata = object.metadata ?? new Uint8Array();
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateGroupAccountMetadataResponse } as MsgUpdateGroupAccountMetadataResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
default:
...
fromPartial<I extends Exact<DeepPartial<MsgUpdateGroupAccountMetadataResponse>, I>>(_: I): MsgUpdateGroupAccountMetadataResponse {
      const message = { ...baseMsgUpdateGroupAccountMetadataResponse } as MsgUpdateGroupAccountMetadataResponse;
return message;
}
          };
...
fromPartial<I extends Exact<DeepPartial<MsgCreateProposalResponse>, I>>(object: I): MsgCreateProposalResponse {
      const message = { ...baseMsgCreateProposalResponse } as MsgCreateProposalResponse;
message.proposalId = (object.proposalId !== undefined && object.proposalId !== null)
...
export class MsgClientImpl implements Msg {private readonly rpc: Rpc;constructor(rpc: Rpc) {this.rpc = rpc;this.CreateGroup = this.CreateGroup.bind(this);this.UpdateGroupMembers = this.UpdateGroupMembers.bind(this);this.UpdateGroupAdmin = this.UpdateGroupAdmin.bind(this);this.UpdateGroupMetadata = this.UpdateGroupMetadata.bind(this);this.CreateGroupAccount = this.CreateGroupAccount.bind(this);this.UpdateGroupAccountAdmin = this.UpdateGroupAccountAdmin.bind(this);this.UpdateGroupAccountDecisionPolicy = this.UpdateGroupAccountDecisionPolicy.bind(this);this.UpdateGroupAccountMetadata = this.UpdateGroupAccountMetadata.bind(this);this.CreateProposal = this.CreateProposal.bind(this);this.Vote = this.Vote.bind(this);this.Exec = this.Exec.bind(this);}
    CreateGroup(
    ...
    UpdateGroupMembers(
      ...
      return promise.then(data => MsgUpdateGroupMembersResponse.decode(new Reader(data)));
    }
    ...
    UpdateGroupAdmin(
      ...
      return promise.then(data => MsgUpdateGroupAdminResponse.decode(new Reader(data)));
    }
    ...
    UpdateGroupMetadata(
      ...
      return promise.then(data => MsgUpdateGroupMetadataResponse.decode(new Reader(data)));
    }
    ...
    CreateGroupAccount(
      ...
      return promise.then(data => MsgCreateGroupAccountResponse.decode(new Reader(data)));
    }
    ...
    UpdateGroupAccountAdmin(
      ...
      return promise.then(data => MsgUpdateGroupAccountAdminResponse.decode(new Reader(data)));
    }
    ...
    UpdateGroupAccountDecisionPolicy(
      ...
      return promise.then(data => MsgUpdateGroupAccountDecisionPolicyResponse.decode(new Reader(data)));
    }
    ...
    UpdateGroupAccountMetadata(
      ...
      return promise.then(data => MsgUpdateGroupAccountMetadataResponse.decode(new Reader(data)));
    }
    ...
    CreateProposal(
      ...
      return promise.then(data => MsgCreateProposalResponse.decode(new Reader(data)));
    }
