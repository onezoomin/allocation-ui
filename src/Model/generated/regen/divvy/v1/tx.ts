...
import { AllocatorEntry } from '../../../regen/divvy/v1/types';
...
fromPartial<I extends Exact<DeepPartial<MsgEmptyResp>, I>>(_: I): MsgEmptyResp {
      const message = { ...baseMsgEmptyResp } as MsgEmptyResp;
return message;
}
          };
...
fromPartial<I extends Exact<DeepPartial<MsgCreateAllocator>, I>>(object: I): MsgCreateAllocator {
      const message = { ...baseMsgCreateAllocator } as MsgCreateAllocator;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgCreateAllocatorResp } as MsgCreateAllocatorResp;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<MsgCreateAllocatorResp>, I>>(object: I): MsgCreateAllocatorResp {
      const message = { ...baseMsgCreateAllocatorResp } as MsgCreateAllocatorResp;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateAllocatorSetting } as MsgUpdateAllocatorSetting;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<MsgUpdateAllocatorSetting>, I>>(object: I): MsgUpdateAllocatorSetting {
      const message = { ...baseMsgUpdateAllocatorSetting } as MsgUpdateAllocatorSetting;
...
for (const v of message.entries) {
            AllocatorEntry.encode(v!, writer.uint32(18).fork()).ldelim();
          }
return writer;
},
...
fromPartial<I extends Exact<DeepPartial<MsgSetAllocationMap>, I>>(object: I): MsgSetAllocationMap {
      const message = { ...baseMsgSetAllocationMap } as MsgSetAllocationMap;
message.sender = object.sender ?? "";
message.entries = object.entries?.map((e) => AllocatorEntry.fromPartial(e)) || [];
return message;
...
fromPartial<I extends Exact<DeepPartial<MsgRemoveAllocator>, I>>(object: I): MsgRemoveAllocator {
      const message = { ...baseMsgRemoveAllocator } as MsgRemoveAllocator;
message.sender = object.sender ?? "";
return message;
}
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgCreateSlowReleaseStream } as MsgCreateSlowReleaseStream;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<MsgCreateSlowReleaseStream>, I>>(object: I): MsgCreateSlowReleaseStream {
      const message = { ...baseMsgCreateSlowReleaseStream } as MsgCreateSlowReleaseStream;
message.admin = object.admin ?? "";
message.start = object.start ?? undefined;
message.interval = (object.interval !== undefined && object.interval !== null)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgPauseSlowReleaseStream } as MsgPauseSlowReleaseStream;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<MsgPauseSlowReleaseStream>, I>>(object: I): MsgPauseSlowReleaseStream {
      const message = { ...baseMsgPauseSlowReleaseStream } as MsgPauseSlowReleaseStream;
message.sender = object.sender ?? "";
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgEditSlowReleaseStream } as MsgEditSlowReleaseStream;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<MsgEditSlowReleaseStream>, I>>(object: I): MsgEditSlowReleaseStream {
      const message = { ...baseMsgEditSlowReleaseStream } as MsgEditSlowReleaseStream;
message.sender = object.sender ?? "";
message.start = object.start ?? undefined;
message.interval = (object.interval !== undefined && object.interval !== null)
 ...
 * module.
 */
CreateAllocator(request: MsgCreateAllocator): Promise<MsgCreateAllocatorResp>;
/** Updates all allocator settings except admin and entry map. */
UpdateAllocatorSetting(request: MsgUpdateAllocatorSetting): Promise<MsgEmptyResp>;
/**
...
RemoveAllocator(request: MsgRemoveAllocator): Promise<MsgCreateAllocatorResp>;
/**
 ...
 */
CreateSlowReleaseStream(request: MsgCreateSlowReleaseStream): Promise<MsgEmptyResp>;
PauseSlowReleaseStream(request: MsgPauseSlowReleaseStream): Promise<MsgEmptyResp>;
EditSlowReleaseStream(request: MsgEditSlowReleaseStream): Promise<MsgEmptyResp>;
}

export class MsgClientImpl implements Msg {private readonly rpc: Rpc;constructor(rpc: Rpc) {this.rpc = rpc;this.CreateAllocator = this.CreateAllocator.bind(this);this.UpdateAllocatorSetting = this.UpdateAllocatorSetting.bind(this);this.SetAllocationMap = this.SetAllocationMap.bind(this);this.RemoveAllocator = this.RemoveAllocator.bind(this);this.CreateSlowReleaseStream = this.CreateSlowReleaseStream.bind(this);this.PauseSlowReleaseStream = this.PauseSlowReleaseStream.bind(this);this.EditSlowReleaseStream = this.EditSlowReleaseStream.bind(this);}
    CreateAllocator(
      ...
      return promise.then(data => MsgCreateAllocatorResp.decode(new Reader(data)));
    }
