...
import { Params, ClassInfo, ProjectInfo, BatchInfo, SellOrder, BuyOrder, CreditType, AskDenom, BasketCriteria, BasketCredit } from '../../../regen/ecocredit/v1alpha2/types';
...
fromJSON(object: any): QueryClassesResponse {
      const message = { ...baseQueryClassesResponse } as QueryClassesResponse;
message.classes = (object.classes ?? []).map((e: any) => ClassInfo.fromJSON(e));
message.pagination = (object.pagination !== undefined && object.pagination !== null)
...
fromPartial<I extends Exact<DeepPartial<QueryClassInfoRequest>, I>>(object: I): QueryClassInfoRequest {
      const message = { ...baseQueryClassInfoRequest } as QueryClassInfoRequest;
...
fromPartial<I extends Exact<DeepPartial<QueryClassInfoResponse>, I>>(object: I): QueryClassInfoResponse {
      const message = { ...baseQueryClassInfoResponse } as QueryClassInfoResponse;
message.info = (object.info !== undefined && object.info !== null)
...
fromPartial<I extends Exact<DeepPartial<QueryProjectsRequest>, I>>(object: I): QueryProjectsRequest {
      const message = { ...baseQueryProjectsRequest } as QueryProjectsRequest;
message.classId = object.classId ?? "";
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageRequest.fromPartial(object.pagination)
...
fromJSON(object: any): QueryProjectsResponse {
      const message = { ...baseQueryProjectsResponse } as QueryProjectsResponse;
message.projects = (object.projects ?? []).map((e: any) => ProjectInfo.fromJSON(e));
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromJSON(object.pagination)
          : undefined;
return message
...
fromPartial<I extends Exact<DeepPartial<QueryProjectsResponse>, I>>(object: I): QueryProjectsResponse {
      const message = { ...baseQueryProjectsResponse } as QueryProjectsResponse;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryProjectInfoRequest } as QueryProjectInfoRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QueryProjectInfoRequest>, I>>(object: I): QueryProjectInfoRequest {
      const message = { ...baseQueryProjectInfoRequest } as QueryProjectInfoRequest;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryProjectInfoResponse } as QueryProjectInfoResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
toJSON(message: QueryProjectInfoResponse): unknown {
      const obj: any = {};
message.info !== undefined && (obj.info = message.info ? ProjectInfo.toJSON(message.info) : undefined);
return obj;
},

fromPartial<I extends Exact<DeepPartial<QueryProjectInfoResponse>, I>>(object: I): QueryProjectInfoResponse {
      const message = { ...baseQueryProjectInfoResponse } as QueryProjectInfoResponse;
message.info = (object.info !== undefined && object.info !== null)
...
fromJSON(object: any): QueryBatchesResponse {
      const message = { ...baseQueryBatchesResponse } as QueryBatchesResponse;
message.batches = (object.batches ?? []).map((e: any) => BatchInfo.fromJSON(e));
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromJSON(object.pagination)
          : undefined;
return message
...
fromJSON(object: any): QueryBatchInfoRequest {
      const message = { ...baseQueryBatchInfoRequest } as QueryBatchInfoRequest;
message.batchDenom = (object.batchDenom !== undefined && object.batchDenom !== null)
...
fromPartial<I extends Exact<DeepPartial<QueryBatchInfoRequest>, I>>(object: I): QueryBatchInfoRequest {
      const message = { ...baseQueryBatchInfoRequest } as QueryBatchInfoRequest;
...
fromPartial<I extends Exact<DeepPartial<QueryBatchInfoResponse>, I>>(object: I): QueryBatchInfoResponse {
      const message = { ...baseQueryBatchInfoResponse } as QueryBatchInfoResponse;
message.info = (object.info !== undefined && object.info !== null)
...
const baseQueryBalanceResponse: object = { tradableAmount: "",retiredAmount: "" };
...
fromJSON(object: any): QueryBalanceResponse {
      const message = { ...baseQueryBalanceResponse } as QueryBalanceResponse;
message.tradableAmount = (object.tradableAmount !== undefined && object.tradableAmount !== null)
          ? String(object.tradableAmount)
          : "";
message.retiredAmount = (object.retiredAmount !== undefined && object.retiredAmount !== null)
...
const baseQuerySupplyResponse: object = { tradableSupply: "",retiredSupply: "" };
...
fromJSON(object: any): QuerySupplyResponse {
      const message = { ...baseQuerySupplyResponse } as QuerySupplyResponse;
message.tradableSupply = (object.tradableSupply !== undefined && object.tradableSupply !== null)
          ? String(object.tradableSupply)
          : "";
message.retiredSupply = (object.retiredSupply !== undefined && object.retiredSupply !== null)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryCreditTypesRequest } as QueryCreditTypesRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
default:
...
fromPartial<I extends Exact<DeepPartial<QueryCreditTypesRequest>, I>>(_: I): QueryCreditTypesRequest {
      const message = { ...baseQueryCreditTypesRequest } as QueryCreditTypesRequest;
return message;
}
          };
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryCreditTypesResponse } as QueryCreditTypesResponse;
message.creditTypes = [];
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
fromJSON(object: any): QueryCreditTypesResponse {
      const message = { ...baseQueryCreditTypesResponse } as QueryCreditTypesResponse;
message.creditTypes = (object.creditTypes ?? []).map((e: any) => CreditType.fromJSON(e));
return message
},
...
fromPartial<I extends Exact<DeepPartial<QueryCreditTypesResponse>, I>>(object: I): QueryCreditTypesResponse {
      const message = { ...baseQueryCreditTypesResponse } as QueryCreditTypesResponse;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQuerySellOrderRequest } as QuerySellOrderRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQuerySellOrderResponse } as QuerySellOrderResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQuerySellOrdersRequest } as QuerySellOrdersRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QuerySellOrdersRequest>, I>>(object: I): QuerySellOrdersRequest {
      const message = { ...baseQuerySellOrdersRequest } as QuerySellOrdersRequest;
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageRequest.fromPartial(object.pagination)
          : undefined;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQuerySellOrdersResponse } as QuerySellOrdersResponse;
message.sellOrders = [];
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
message.sellOrders.push(SellOrder.decode(reader, reader.uint32()));
break;
case 2:
message.pagination = PageResponse.decode(reader, reader.uint32());
break;
...
fromJSON(object: any): QuerySellOrdersResponse {
      const message = { ...baseQuerySellOrdersResponse } as QuerySellOrdersResponse;
message.sellOrders = (object.sellOrders ?? []).map((e: any) => SellOrder.fromJSON(e));
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromJSON(object.pagination)
          : undefined;
return message
...
if (message.sellOrders) {
          obj.sellOrders = message.sellOrders.map(e => e ? SellOrder.toJSON(e) : undefined);
        } else {
          obj.sellOrders = [];
        }
message.pagination !== undefined && (obj.pagination = message.pagination ? PageResponse.toJSON(message.pagination) : undefined);
...
fromPartial<I extends Exact<DeepPartial<QuerySellOrdersResponse>, I>>(object: I): QuerySellOrdersResponse {
      const message = { ...baseQuerySellOrdersResponse } as QuerySellOrdersResponse;
message.sellOrders = object.sellOrders?.map((e) => SellOrder.fromPartial(e)) || [];
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromPartial(object.pagination)
          : undefined;
return message;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQuerySellOrdersByBatchDenomRequest } as QuerySellOrdersByBatchDenomRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QuerySellOrdersByBatchDenomRequest>, I>>(object: I): QuerySellOrdersByBatchDenomRequest {
      const message = { ...baseQuerySellOrdersByBatchDenomRequest } as QuerySellOrdersByBatchDenomRequest;
message.batchDenom = object.batchDenom ?? "";
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageRequest.fromPartial(object.pagination)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQuerySellOrdersByBatchDenomResponse } as QuerySellOrdersByBatchDenomResponse;
message.sellOrders = [];
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
fromPartial<I extends Exact<DeepPartial<QuerySellOrdersByBatchDenomResponse>, I>>(object: I): QuerySellOrdersByBatchDenomResponse {
      const message = { ...baseQuerySellOrdersByBatchDenomResponse } as QuerySellOrdersByBatchDenomResponse;
message.sellOrders = object.sellOrders?.map((e) => SellOrder.fromPartial(e)) || [];
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromPartial(object.pagination)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQuerySellOrdersByAddressRequest } as QuerySellOrdersByAddressRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QuerySellOrdersByAddressRequest>, I>>(object: I): QuerySellOrdersByAddressRequest {
      const message = { ...baseQuerySellOrdersByAddressRequest } as QuerySellOrdersByAddressRequest;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQuerySellOrdersByAddressResponse } as QuerySellOrdersByAddressResponse;
message.sellOrders = [];
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
fromPartial<I extends Exact<DeepPartial<QuerySellOrdersByAddressResponse>, I>>(object: I): QuerySellOrdersByAddressResponse {
      const message = { ...baseQuerySellOrdersByAddressResponse } as QuerySellOrdersByAddressResponse;
message.sellOrders = object.sellOrders?.map((e) => SellOrder.fromPartial(e)) || [];
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromPartial(object.pagination)
...
fromPartial<I extends Exact<DeepPartial<QueryBuyOrderRequest>, I>>(object: I): QueryBuyOrderRequest {
      const message = { ...baseQueryBuyOrderRequest } as QueryBuyOrderRequest;
message.buyOrderId = (object.buyOrderId !== undefined && object.buyOrderId !== null)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryBuyOrderResponse } as QueryBuyOrderResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QueryBuyOrderResponse>, I>>(object: I): QueryBuyOrderResponse {
      const message = { ...baseQueryBuyOrderResponse } as QueryBuyOrderResponse;
message.buyOrder = (object.buyOrder !== undefined && object.buyOrder !== null)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryBuyOrdersRequest } as QueryBuyOrdersRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QueryBuyOrdersRequest>, I>>(object: I): QueryBuyOrdersRequest {
      const message = { ...baseQueryBuyOrdersRequest } as QueryBuyOrdersRequest;
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageRequest.fromPartial(object.pagination)
          : undefined;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryBuyOrdersResponse } as QueryBuyOrdersResponse;
message.buyOrders = [];
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
fromJSON(object: any): QueryBuyOrdersResponse {
      const message = { ...baseQueryBuyOrdersResponse } as QueryBuyOrdersResponse;
message.buyOrders = (object.buyOrders ?? []).map((e: any) => BuyOrder.fromJSON(e));
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromJSON(object.pagination)
          : undefined;
return message
...
fromPartial<I extends Exact<DeepPartial<QueryBuyOrdersResponse>, I>>(object: I): QueryBuyOrdersResponse {
      const message = { ...baseQueryBuyOrdersResponse } as QueryBuyOrdersResponse;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryBuyOrdersByAddressRequest } as QueryBuyOrdersByAddressRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QueryBuyOrdersByAddressRequest>, I>>(object: I): QueryBuyOrdersByAddressRequest {
      const message = { ...baseQueryBuyOrdersByAddressRequest } as QueryBuyOrdersByAddressRequest;
message.address = object.address ?? "";
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageRequest.fromPartial(object.pagination)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryBuyOrdersByAddressResponse } as QueryBuyOrdersByAddressResponse;
message.buyOrders = [];
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
fromPartial<I extends Exact<DeepPartial<QueryBuyOrdersByAddressResponse>, I>>(object: I): QueryBuyOrdersByAddressResponse {
      const message = { ...baseQueryBuyOrdersByAddressResponse } as QueryBuyOrdersByAddressResponse;
message.buyOrders = object.buyOrders?.map((e) => BuyOrder.fromPartial(e)) || [];
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromPartial(object.pagination)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryAllowedAskDenomsRequest } as QueryAllowedAskDenomsRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QueryAllowedAskDenomsRequest>, I>>(object: I): QueryAllowedAskDenomsRequest {
      const message = { ...baseQueryAllowedAskDenomsRequest } as QueryAllowedAskDenomsRequest;
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageRequest.fromPartial(object.pagination)
          : undefined;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryAllowedAskDenomsResponse } as QueryAllowedAskDenomsResponse;
message.askDenoms = [];
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
message.askDenoms.push(AskDenom.decode(reader, reader.uint32()));
break;
case 2:
message.pagination = PageResponse.decode(reader, reader.uint32());
break;
...
fromJSON(object: any): QueryAllowedAskDenomsResponse {
      const message = { ...baseQueryAllowedAskDenomsResponse } as QueryAllowedAskDenomsResponse;
message.askDenoms = (object.askDenoms ?? []).map((e: any) => AskDenom.fromJSON(e));
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromJSON(object.pagination)
          : undefined;
return message
...
if (message.askDenoms) {
          obj.askDenoms = message.askDenoms.map(e => e ? AskDenom.toJSON(e) : undefined);
        } else {
          obj.askDenoms = [];
        }
message.pagination !== undefined && (obj.pagination = message.pagination ? PageResponse.toJSON(message.pagination) : undefined);
...
fromPartial<I extends Exact<DeepPartial<QueryAllowedAskDenomsResponse>, I>>(object: I): QueryAllowedAskDenomsResponse {
      const message = { ...baseQueryAllowedAskDenomsResponse } as QueryAllowedAskDenomsResponse;
message.askDenoms = object.askDenoms?.map((e) => AskDenom.fromPartial(e)) || [];
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromPartial(object.pagination)
          : undefined;
return message;
...
const baseBasket: object = { curator: "",name: "",displayName: "",exponent: 0,disableAutoRetire: false,allowPicking: false };
...
break;
case 5:
message.basketCriteria.push(BasketCriteria.decode(reader, reader.uint32()));
break;
case 6:
...
fromJSON(object: any): Basket {
      const message = { ...baseBasket } as Basket;
message.curator = (object.curator !== undefined && object.curator !== null)
...
message.exponent = (object.exponent !== undefined && object.exponent !== null)
          ...
          : 0;
message.basketCriteria = (object.basketCriteria ?? []).map((e: any) => BasketCriteria.fromJSON(e));
message.disableAutoRetire = (object.disableAutoRetire !== undefined && object.disableAutoRetire !== null)
          ? Boolean(object.disableAutoRetire)
          : false;
message.allowPicking = (object.allowPicking !== undefined && object.allowPicking !== null)
...
if (message.basketCriteria) {
          obj.basketCriteria = message.basketCriteria.map(e => e ? BasketCriteria.toJSON(e) : undefined);
        } else {
          obj.basketCriteria = [];
        }
message.disableAutoRetire !== undefined && (obj.disableAutoRetire = message.disableAutoRetire);
message.allowPicking !== undefined && (obj.allowPicking = message.allowPicking);
return obj;
},
...
message.basketCriteria = object.basketCriteria?.map((e) => BasketCriteria.fromPartial(e)) || [];
...
fromJSON(object: any): QueryBasketRequest {
      const message = { ...baseQueryBasketRequest } as QueryBasketRequest;
message.basketDenom = (object.basketDenom !== undefined && object.basketDenom !== null)
...
fromPartial<I extends Exact<DeepPartial<QueryBasketRequest>, I>>(object: I): QueryBasketRequest {
      const message = { ...baseQueryBasketRequest } as QueryBasketRequest;
...
fromPartial<I extends Exact<DeepPartial<QueryBasketResponse>, I>>(object: I): QueryBasketResponse {
      const message = { ...baseQueryBasketResponse } as QueryBasketResponse;
message.basket = (object.basket !== undefined && object.basket !== null)
...
fromPartial<I extends Exact<DeepPartial<QueryBasketsRequest>, I>>(object: I): QueryBasketsRequest {
      const message = { ...baseQueryBasketsRequest } as QueryBasketsRequest;
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageRequest.fromPartial(object.pagination)
          : undefined;
...
fromJSON(object: any): QueryBasketsResponse {
      const message = { ...baseQueryBasketsResponse } as QueryBasketsResponse;
message.baskets = (object.baskets ?? []).map((e: any) => Basket.fromJSON(e));
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromJSON(object.pagination)
          : undefined;
return message
...
fromPartial<I extends Exact<DeepPartial<QueryBasketsResponse>, I>>(object: I): QueryBasketsResponse {
      const message = { ...baseQueryBasketsResponse } as QueryBasketsResponse;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryBasketCreditsRequest } as QueryBasketCreditsRequest;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<QueryBasketCreditsRequest>, I>>(object: I): QueryBasketCreditsRequest {
      const message = { ...baseQueryBasketCreditsRequest } as QueryBasketCreditsRequest;
message.basketDenom = object.basketDenom ?? "";
return message;
}
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseQueryBasketCreditsResponse } as QueryBasketCreditsResponse;
message.credits = [];
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
fromJSON(object: any): QueryBasketCreditsResponse {
      const message = { ...baseQueryBasketCreditsResponse } as QueryBasketCreditsResponse;
message.credits = (object.credits ?? []).map((e: any) => BasketCredit.fromJSON(e));
message.pagination = (object.pagination !== undefined && object.pagination !== null)
          ? PageResponse.fromJSON(object.pagination)
          : undefined;
return message
...
fromPartial<I extends Exact<DeepPartial<QueryBasketCreditsResponse>, I>>(object: I): QueryBasketCreditsResponse {
      const message = { ...baseQueryBasketCreditsResponse } as QueryBasketCreditsResponse;
...
ProjectInfo(request: QueryProjectInfoRequest): Promise<QueryProjectInfoResponse>;
...
BuyOrdersByAddress(request: QueryBuyOrdersByAddressRequest): Promise<QueryBuyOrdersByAddressResponse>;
/** AllowedAskDenoms queries all denoms allowed to be set in the AskPrice of a sell order */
AllowedAskDenoms(request: QueryAllowedAskDenomsRequest): Promise<QueryAllowedAskDenomsResponse>;
...
BasketCredits(request: QueryBasketCreditsRequest): Promise<QueryBasketCreditsResponse>;
}

export class QueryClientImpl implements Query {private readonly rpc: Rpc;constructor(rpc: Rpc) {this.rpc = rpc;this.Classes = this.Classes.bind(this);this.ClassInfo = this.ClassInfo.bind(this);this.Projects = this.Projects.bind(this);this.ProjectInfo = this.ProjectInfo.bind(this);this.Batches = this.Batches.bind(this);this.BatchInfo = this.BatchInfo.bind(this);this.Balance = this.Balance.bind(this);this.Supply = this.Supply.bind(this);this.CreditTypes = this.CreditTypes.bind(this);this.Params = this.Params.bind(this);this.SellOrder = this.SellOrder.bind(this);this.SellOrders = this.SellOrders.bind(this);this.SellOrdersByBatchDenom = this.SellOrdersByBatchDenom.bind(this);this.SellOrdersByAddress = this.SellOrdersByAddress.bind(this);this.BuyOrder = this.BuyOrder.bind(this);this.BuyOrders = this.BuyOrders.bind(this);this.BuyOrdersByAddress = this.BuyOrdersByAddress.bind(this);this.AllowedAskDenoms = this.AllowedAskDenoms.bind(this);this.Basket = this.Basket.bind(this);this.Baskets = this.Baskets.bind(this);this.BasketCredits = this.BasketCredits.bind(this);}
    Classes(
      ...
      return promise.then(data => QueryClassesResponse.decode(new Reader(data)));
    }
    ...
    Projects(
      ...
      return promise.then(data => QueryProjectsResponse.decode(new Reader(data)));
    }
    ...
    ProjectInfo(
      ...
      return promise.then(data => QueryProjectInfoResponse.decode(new Reader(data)));
    }
    ...
    Batches(
      ...
      return promise.then(data => QueryBatchesResponse.decode(new Reader(data)));
    }
    ...
    CreditTypes(
      ...
      return promise.then(data => QueryCreditTypesResponse.decode(new Reader(data)));
    }
    ...
    SellOrder(
      ...
      return promise.then(data => QuerySellOrderResponse.decode(new Reader(data)));
    }
    ...
    SellOrders(
      ...
      return promise.then(data => QuerySellOrdersResponse.decode(new Reader(data)));
    }
    ...
    SellOrdersByBatchDenom(
      ...
      return promise.then(data => QuerySellOrdersByBatchDenomResponse.decode(new Reader(data)));
    }
    ...
    SellOrdersByAddress(
      ...
      return promise.then(data => QuerySellOrdersByAddressResponse.decode(new Reader(data)));
    }
  
    BuyOrder(
      request: QueryBuyOrderRequest
    ): Promise<QueryBuyOrderResponse> {
      ...
      return promise.then(data => QueryBuyOrderResponse.decode(new Reader(data)));
    }
  
    BuyOrders(
      request: QueryBuyOrdersRequest
    ): Promise<QueryBuyOrdersResponse> {
      ...
      return promise.then(data => QueryBuyOrdersResponse.decode(new Reader(data)));
    }
    ...
    BuyOrdersByAddress(
      ...
      return promise.then(data => QueryBuyOrdersByAddressResponse.decode(new Reader(data)));
    }
    ...
    AllowedAskDenoms(
      ...
      return promise.then(data => QueryAllowedAskDenomsResponse.decode(new Reader(data)));
    }
    ...
    Basket(
      ...
      return promise.then(data => QueryBasketResponse.decode(new Reader(data)));
    }
    ...
    Baskets(
      ...
      return promise.then(data => QueryBasketsResponse.decode(new Reader(data)));
    }
    ...
    BasketCredits(
      ...
      return promise.then(data => QueryBasketCreditsResponse.decode(new Reader(data)));
    }
  }
