...
const baseClassInfo: object = { classId: "",admin: "",issuers: "",numBatches: Long.UZERO };
...
message.creditType = (object.creditType !== undefined && object.creditType !== null)
          ...
          : undefined;
message.numBatches = (object.numBatches !== undefined && object.numBatches !== null)
...
fromPartial<I extends Exact<DeepPartial<ClassInfo>, I>>(object: I): ClassInfo {
      const message = { ...baseClassInfo } as ClassInfo;
...
const baseProjectInfo: object = { projectId: "",classId: "",issuer: "",projectLocation: "" };
...
const baseBatchInfo: object = { projectId: "",batchDenom: "",totalAmount: "",amountCancelled: "" };
...
message.metadata = (object.metadata !== undefined && object.metadata !== null)
          ? bytesFromBase64(object.metadata)
          : new Uint8Array();
message.amountCancelled = (object.amountCancelled !== undefined && object.amountCancelled !== null)
...
const baseParams: object = { allowedClassCreators: "",allowlistEnabled: false };
...
fromJSON(object: any): Params {
      const message = { ...baseParams } as Params;
message.creditClassFee = (object.creditClassFee ?? []).map((e: any) => Coin.fromJSON(e));
message.allowedClassCreators = (object.allowedClassCreators ?? []).map((e: any) => String(e));
message.allowlistEnabled = (object.allowlistEnabled !== undefined && object.allowlistEnabled !== null)
...
const baseCreditType: object = { name: "",abbreviation: "",unit: "",precision: 0 };
...
message.name = (object.name !== undefined && object.name !== null)
          ? String(object.name)
          : "";
message.abbreviation = (object.abbreviation !== undefined && object.abbreviation !== null)
...
message.abbreviation = (object.abbreviation !== undefined && object.abbreviation !== null)
          ? String(object.abbreviation)
          : "";
message.seqNumber = (object.seqNumber !== undefined && object.seqNumber !== null)
...
fromPartial<I extends Exact<DeepPartial<CreditTypeSeq>, I>>(object: I): CreditTypeSeq {
      const message = { ...baseCreditTypeSeq } as CreditTypeSeq;
message.abbreviation = object.abbreviation ?? "";
message.seqNumber = (object.seqNumber !== undefined && object.seqNumber !== null)
...
const baseSellOrder: object = { orderId: Long.UZERO,owner: "",batchDenom: "",quantity: "",disableAutoRetire: false };
...
const baseBuyOrder: object = { buyOrderId: Long.UZERO,buyer: "",quantity: "",disableAutoRetire: false,disablePartialFill: false };
...
if (message.selection !== undefined) {
          BuyOrder_Selection.encode(message.selection, writer.uint32(26).fork()).ldelim();
        }
if (message.quantity !== "") {
          writer.uint32(34).string(message.quantity);
        }
...
break;
case 3:
message.selection = BuyOrder_Selection.decode(reader, reader.uint32());
break;
case 4:
message.quantity = reader.string();
break;
...
message.selection !== undefined && (obj.selection = message.selection ? BuyOrder_Selection.toJSON(message.selection) : undefined);
message.quantity !== undefined && (obj.quantity = message.quantity);
...
fromPartial<I extends Exact<DeepPartial<BuyOrder_Selection>, I>>(object: I): BuyOrder_Selection {
      const message = { ...baseBuyOrder_Selection } as BuyOrder_Selection;
message.sellOrderId = (object.sellOrderId !== undefined && object.sellOrderId !== null)
...
fromPartial<I extends Exact<DeepPartial<AskDenom>, I>>(object: I): AskDenom {
      const message = { ...baseAskDenom } as AskDenom;
...
fromPartial<I extends Exact<DeepPartial<BasketCredit>, I>>(object: I): BasketCredit {
      const message = { ...baseBasketCredit } as BasketCredit;
message.batchDenom = object.batchDenom ?? "";
...
fromPartial<I extends Exact<DeepPartial<BasketCriteria>, I>>(object: I): BasketCriteria {
      const message = { ...baseBasketCriteria } as BasketCriteria;
message.filter = (object.filter !== undefined && object.filter !== null)
...
if (message.dateRange !== undefined) {
          Filter_DateRange.encode(message.dateRange, writer.uint32(90).fork()).ldelim();
        }
...
break;
case 11:
message.dateRange = Filter_DateRange.decode(reader, reader.uint32());
break;
case 12:
...
message.and = (object.and !== undefined && object.and !== null)
          ...
          : undefined;
message.or = (object.or !== undefined && object.or !== null)
...
message.batchDenom = (object.batchDenom !== undefined && object.batchDenom !== null)
          ? String(object.batchDenom)
          : undefined;
message.classAdmin = (object.classAdmin !== undefined && object.classAdmin !== null)
...
toJSON(message: Filter): unknown {
      const obj: any = {};
message.and !== undefined && (obj.and = message.and ? Filter_And.toJSON(message.and) : undefined);
message.or !== undefined && (obj.or = message.or ? Filter_Or.toJSON(message.or) : undefined);
message.creditTypeName !== undefined && (obj.creditTypeName = message.creditTypeName);
message.classId !== undefined && (obj.classId = message.classId);
message.projectId !== undefined && (obj.projectId = message.projectId);
message.batchDenom !== undefined && (obj.batchDenom = message.batchDenom);
message.classAdmin !== undefined && (obj.classAdmin = message.classAdmin);
message.issuer !== undefined && (obj.issuer = message.issuer);
message.owner !== undefined && (obj.owner = message.owner);
message.projectLocation !== undefined && (obj.projectLocation = message.projectLocation);
message.dateRange !== undefined && (obj.dateRange = message.dateRange ? Filter_DateRange.toJSON(message.dateRange) : undefined);
...
fromPartial<I extends Exact<DeepPartial<Filter_And>, I>>(object: I): Filter_And {
      const message = { ...baseFilter_And } as Filter_And;
...
fromPartial<I extends Exact<DeepPartial<Filter_Or>, I>>(object: I): Filter_Or {
      const message = { ...baseFilter_Or } as Filter_Or;
message.filters = object.filters?.map((e) => Filter.fromPartial(e)) || [];
return message;
}
...
fromPartial<I extends Exact<DeepPartial<Filter_DateRange>, I>>(object: I): Filter_DateRange {
      const message = { ...baseFilter_DateRange } as Filter_DateRange;
message.startDate = object.startDate ?? undefined;
message.endDate = object.endDate ?? undefined;
return message;
