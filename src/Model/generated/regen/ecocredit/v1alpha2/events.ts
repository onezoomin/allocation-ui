...
const baseEventCreateProject: object = { projectId: "",classId: "",issuer: "",projectLocation: "" };
...
fromPartial<I extends Exact<DeepPartial<EventCreateProject>, I>>(object: I): EventCreateProject {
      const message = { ...baseEventCreateProject } as EventCreateProject;
...
const baseEventCreateBatch: object = { classId: "",batchDenom: "",issuer: "",totalAmount: "",startDate: "",endDate: "",projectLocation: "",projectId: "" };
...
fromPartial<I extends Exact<DeepPartial<EventCreateBatch>, I>>(object: I): EventCreateBatch {
      const message = { ...baseEventCreateBatch } as EventCreateBatch;
message.classId = object.classId ?? "";
...
const baseEventReceive: object = { sender: "",recipient: "",batchDenom: "",tradableAmount: "",retiredAmount: "" };
...
fromPartial<I extends Exact<DeepPartial<EventReceive>, I>>(object: I): EventReceive {
      const message = { ...baseEventReceive } as EventReceive;
...
const baseEventRetire: object = { retirer: "",batchDenom: "",amount: "",location: "" };
...
fromJSON(object: any): EventRetire {
      const message = { ...baseEventRetire } as EventRetire;
message.retirer = (object.retirer !== undefined && object.retirer !== null)
...
fromPartial<I extends Exact<DeepPartial<EventRetire>, I>>(object: I): EventRetire {
      const message = { ...baseEventRetire } as EventRetire;
...
fromJSON(object: any): EventCancel {
      const message = { ...baseEventCancel } as EventCancel;
message.canceller = (object.canceller !== undefined && object.canceller !== null)
...
fromPartial<I extends Exact<DeepPartial<EventCancel>, I>>(object: I): EventCancel {
      const message = { ...baseEventCancel } as EventCancel;
...
const baseEventSell: object = { orderId: Long.UZERO,batchDenom: "",quantity: "",disableAutoRetire: false };
...
fromPartial<I extends Exact<DeepPartial<EventSell>, I>>(object: I): EventSell {
      const message = { ...baseEventSell } as EventSell;
message.orderId = (object.orderId !== undefined && object.orderId !== null)
...
const baseEventUpdateSellOrder: object = { owner: "",sellOrderId: Long.UZERO,batchDenom: "",newQuantity: "",disableAutoRetire: false };
...
fromPartial<I extends Exact<DeepPartial<EventUpdateSellOrder>, I>>(object: I): EventUpdateSellOrder {
      const message = { ...baseEventUpdateSellOrder } as EventUpdateSellOrder;
...
const baseEventBuyOrderCreated: object = { buyOrderId: Long.UZERO,sellOrderId: Long.UZERO,quantity: "",disableAutoRetire: false,disablePartialFill: false };
...
fromPartial<I extends Exact<DeepPartial<EventBuyOrderCreated>, I>>(object: I): EventBuyOrderCreated {
      const message = { ...baseEventBuyOrderCreated } as EventBuyOrderCreated;
message.buyOrderId = (object.buyOrderId !== undefined && object.buyOrderId !== null)
...
const baseEventBuyOrderFilled: object = { buyOrderId: Long.UZERO,sellOrderId: Long.UZERO,batchDenom: "",quantity: "" };
...
message.batchDenom !== undefined && (obj.batchDenom = message.batchDenom);
message.quantity !== undefined && (obj.quantity = message.quantity);
message.totalPrice !== undefined && (obj.totalPrice = message.totalPrice ? Coin.toJSON(message.totalPrice) : undefined);
return obj;
},

fromPartial<I extends Exact<DeepPartial<EventBuyOrderFilled>, I>>(object: I): EventBuyOrderFilled {
      const message = { ...baseEventBuyOrderFilled } as EventBuyOrderFilled;
message.buyOrderId = (object.buyOrderId !== undefined && object.buyOrderId !== null)
          ? Long.fromValue(object.buyOrderId)
          : Long.UZERO;
...
const baseEventAllowAskDenom: object = { denom: "",displayDenom: "",exponent: 0 };
...
fromPartial<I extends Exact<DeepPartial<EventAllowAskDenom>, I>>(object: I): EventAllowAskDenom {
      const message = { ...baseEventAllowAskDenom } as EventAllowAskDenom;
