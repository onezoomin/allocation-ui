...
import { BasketCriteria, BasketCredit } from '../../../regen/ecocredit/v1alpha2/types';
...
const baseMsgCreateClass: object = { admin: "",issuers: "",creditTypeName: "" };
...
message.metadata = (object.metadata !== undefined && object.metadata !== null)
          ...
          : new Uint8Array();
message.creditTypeName = (object.creditTypeName !== undefined && object.creditTypeName !== null)
...
const baseMsgCreateProject: object = { issuer: "",classId: "",projectLocation: "",projectId: "" };
...
message.metadata = (object.metadata !== undefined && object.metadata !== null)
          ? bytesFromBase64(object.metadata)
          : new Uint8Array();
message.projectLocation = (object.projectLocation !== undefined && object.projectLocation !== null)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgCreateProjectResponse } as MsgCreateProjectResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
message.projectId = (object.projectId !== undefined && object.projectId !== null)
          ? String(object.projectId)
          : "";
message.issuance = (object.issuance ?? []).map((e: any) => MsgCreateBatch_BatchIssuance.fromJSON(e));
message.metadata = (object.metadata !== undefined && object.metadata !== null)
          ? bytesFromBase64(object.metadata)
          : new Uint8Array();
...
const baseMsgCreateBatch_BatchIssuance: object = { recipient: "",tradableAmount: "",retiredAmount: "",retirementLocation: "" };
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgCreateBatch_BatchIssuance } as MsgCreateBatch_BatchIssuance;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
message.retiredAmount = (object.retiredAmount !== undefined && object.retiredAmount !== null)
          ...
          : "";
message.retirementLocation = (object.retirementLocation !== undefined && object.retirementLocation !== null)
...
fromPartial<I extends Exact<DeepPartial<MsgCreateBatch_BatchIssuance>, I>>(object: I): MsgCreateBatch_BatchIssuance {
      const message = { ...baseMsgCreateBatch_BatchIssuance } as MsgCreateBatch_BatchIssuance;
...
message.recipient = (object.recipient !== undefined && object.recipient !== null)
          ? String(object.recipient)
          : "";
message.credits = (object.credits ?? []).map((e: any) => MsgSend_SendCredits.fromJSON(e));
return message
},
...
const baseMsgSend_SendCredits: object = { batchDenom: "",tradableAmount: "",retiredAmount: "",retirementLocation: "" };
...
message.holder = (object.holder !== undefined && object.holder !== null)
          ...
          : "";
message.credits = (object.credits ?? []).map((e: any) => MsgRetire_RetireCredits.fromJSON(e));
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgRetire_RetireCredits } as MsgRetire_RetireCredits;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<MsgRetire_RetireCredits>, I>>(object: I): MsgRetire_RetireCredits {
      const message = { ...baseMsgRetire_RetireCredits } as MsgRetire_RetireCredits;
message.batchDenom = object.batchDenom ?? "";
...
message.holder = (object.holder !== undefined && object.holder !== null)
          ? String(object.holder)
          : "";
message.credits = (object.credits ?? []).map((e: any) => MsgCancel_CancelCredits.fromJSON(e));
return message
},
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgCancel_CancelCredits } as MsgCancel_CancelCredits;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<MsgCancel_CancelCredits>, I>>(object: I): MsgCancel_CancelCredits {
      const message = { ...baseMsgCancel_CancelCredits } as MsgCancel_CancelCredits;
message.batchDenom = object.batchDenom ?? "";
message.amount = object.amount ?? "";
return message;
...
const baseMsgUpdateClassAdmin: object = { admin: "",classId: "",newAdmin: "" };
...
message.classId = (object.classId !== undefined && object.classId !== null)
          ? String(object.classId)
          : "";
message.newAdmin = (object.newAdmin !== undefined && object.newAdmin !== null)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateClassAdminResponse } as MsgUpdateClassAdminResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
default:
...
const baseMsgUpdateClassIssuers: object = { admin: "",classId: "",issuers: "" };
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateClassIssuers } as MsgUpdateClassIssuers;
message.issuers = [];
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateClassIssuersResponse } as MsgUpdateClassIssuersResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
default:
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateClassMetadata } as MsgUpdateClassMetadata;
message.metadata = new Uint8Array();
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateClassMetadataResponse } as MsgUpdateClassMetadataResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
default:
...
message.owner = (object.owner !== undefined && object.owner !== null)
          ? String(object.owner)
          : "";
message.orders = (object.orders ?? []).map((e: any) => MsgSell_Order.fromJSON(e));
return message
},
...
const baseMsgSell_Order: object = { batchDenom: "",quantity: "",disableAutoRetire: false };
...
fromPartial<I extends Exact<DeepPartial<MsgSell_Order>, I>>(object: I): MsgSell_Order {
      const message = { ...baseMsgSell_Order } as MsgSell_Order;
message.batchDenom = object.batchDenom ?? "";
...
fromJSON(object: any): MsgSellResponse {
      const message = { ...baseMsgSellResponse } as MsgSellResponse;
message.sellOrderIds = (object.sellOrderIds ?? []).map((e: any) => Long.fromString(e));
return message
},
...
message.owner = (object.owner !== undefined && object.owner !== null)
          ? String(object.owner)
          : "";
message.updates = (object.updates ?? []).map((e: any) => MsgUpdateSellOrders_Update.fromJSON(e));
return message
},
...
fromPartial<I extends Exact<DeepPartial<MsgUpdateSellOrders>, I>>(object: I): MsgUpdateSellOrders {
      const message = { ...baseMsgUpdateSellOrders } as MsgUpdateSellOrders;
message.owner = object.owner ?? "";
...
const baseMsgUpdateSellOrders_Update: object = { sellOrderId: Long.UZERO,newQuantity: "",disableAutoRetire: false };
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateSellOrders_Update } as MsgUpdateSellOrders_Update;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
message.sellOrderId = (object.sellOrderId !== undefined && object.sellOrderId !== null)
          ...
          : Long.UZERO;
message.newQuantity = (object.newQuantity !== undefined && object.newQuantity !== null)
...
fromPartial<I extends Exact<DeepPartial<MsgUpdateSellOrders_Update>, I>>(object: I): MsgUpdateSellOrders_Update {
      const message = { ...baseMsgUpdateSellOrders_Update } as MsgUpdateSellOrders_Update;
message.sellOrderId = (object.sellOrderId !== undefined && object.sellOrderId !== null)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgUpdateSellOrdersResponse } as MsgUpdateSellOrdersResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
default:
...
fromPartial<I extends Exact<DeepPartial<MsgUpdateSellOrdersResponse>, I>>(_: I): MsgUpdateSellOrdersResponse {
      const message = { ...baseMsgUpdateSellOrdersResponse } as MsgUpdateSellOrdersResponse;
return message;
}
          };
...
break;
case 2:
message.orders.push(MsgBuy_Order.decode(reader, reader.uint32()));
break;
default:
      reader.skipType(tag & 7);
      break;
...
message.buyer = (object.buyer !== undefined && object.buyer !== null)
          ? String(object.buyer)
          : "";
message.orders = (object.orders ?? []).map((e: any) => MsgBuy_Order.fromJSON(e));
return message
},
...
if (message.orders) {
          obj.orders = message.orders.map(e => e ? MsgBuy_Order.toJSON(e) : undefined);
        } else {
          obj.orders = [];
        }
return obj;
...
message.orders = object.orders?.map((e) => MsgBuy_Order.fromPartial(e)) || [];
return message;
}
          };

const baseMsgBuy_Order: object = { quantity: "",disableAutoRetire: false,disablePartialFill: false };
...
if (message.selection !== undefined) {
          MsgBuy_Order_Selection.encode(message.selection, writer.uint32(10).fork()).ldelim();
        }
if (message.quantity !== "") {
          writer.uint32(18).string(message.quantity);
        }
...
while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
case 1:
message.selection = MsgBuy_Order_Selection.decode(reader, reader.uint32());
break;
case 2:
message.quantity = reader.string();
break;
...
message.disableAutoRetire = (object.disableAutoRetire !== undefined && object.disableAutoRetire !== null)
          ? Boolean(object.disableAutoRetire)
          : false;
message.disablePartialFill = (object.disablePartialFill !== undefined && object.disablePartialFill !== null)
...
toJSON(message: MsgBuy_Order): unknown {
      const obj: any = {};
message.selection !== undefined && (obj.selection = message.selection ? MsgBuy_Order_Selection.toJSON(message.selection) : undefined);
message.quantity !== undefined && (obj.quantity = message.quantity);
message.bidPrice !== undefined && (obj.bidPrice = message.bidPrice ? Coin.toJSON(message.bidPrice) : undefined);
message.disableAutoRetire !== undefined && (obj.disableAutoRetire = message.disableAutoRetire);
message.disablePartialFill !== undefined && (obj.disablePartialFill = message.disablePartialFill);
return obj;
},

fromPartial<I extends Exact<DeepPartial<MsgBuy_Order>, I>>(object: I): MsgBuy_Order {
      const message = { ...baseMsgBuy_Order } as MsgBuy_Order;
message.selection = (object.selection !== undefined && object.selection !== null)
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgBuy_Order_Selection } as MsgBuy_Order_Selection;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
toJSON(message: MsgBuy_Order_Selection): unknown {
      const obj: any = {};
message.sellOrderId !== undefined && (obj.sellOrderId = (message.sellOrderId || undefined).toString());
return obj;
},

fromPartial<I extends Exact<DeepPartial<MsgBuy_Order_Selection>, I>>(object: I): MsgBuy_Order_Selection {
      const message = { ...baseMsgBuy_Order_Selection } as MsgBuy_Order_Selection;
message.sellOrderId = (object.sellOrderId !== undefined && object.sellOrderId !== null)
          ? Long.fromValue(object.sellOrderId)
          : undefined;
...
fromJSON(object: any): MsgBuyResponse {
      const message = { ...baseMsgBuyResponse } as MsgBuyResponse;
message.buyOrderIds = (object.buyOrderIds ?? []).map((e: any) => Long.fromString(e));
return message
},
...
if (message.buyOrderIds) {
          obj.buyOrderIds = message.buyOrderIds.map(e => (e || Long.UZERO).toString());
        } else {
          obj.buyOrderIds = [];
        }
return obj;
...
fromPartial<I extends Exact<DeepPartial<MsgBuyResponse>, I>>(object: I): MsgBuyResponse {
      const message = { ...baseMsgBuyResponse } as MsgBuyResponse;
message.buyOrderIds = object.buyOrderIds?.map((e) => Long.fromValue(e)) || [];
return message;
}
          };

const baseMsgAllowAskDenom: object = { rootAddress: "",denom: "",displayDenom: "",exponent: 0 };
...
fromJSON(object: any): MsgAllowAskDenom {
      const message = { ...baseMsgAllowAskDenom } as MsgAllowAskDenom;
message.rootAddress = (object.rootAddress !== undefined && object.rootAddress !== null)
          ? String(object.rootAddress)
          : "";
message.denom = (object.denom !== undefined && object.denom !== null)
          ? String(object.denom)
          : "";
message.displayDenom = (object.displayDenom !== undefined && object.displayDenom !== null)
...
toJSON(message: MsgAllowAskDenom): unknown {
      const obj: any = {};
message.rootAddress !== undefined && (obj.rootAddress = message.rootAddress);
...
fromPartial<I extends Exact<DeepPartial<MsgAllowAskDenom>, I>>(object: I): MsgAllowAskDenom {
      const message = { ...baseMsgAllowAskDenom } as MsgAllowAskDenom;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgAllowAskDenomResponse } as MsgAllowAskDenomResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
default:
...
fromPartial<I extends Exact<DeepPartial<MsgAllowAskDenomResponse>, I>>(_: I): MsgAllowAskDenomResponse {
      const message = { ...baseMsgAllowAskDenomResponse } as MsgAllowAskDenomResponse;
return message;
}
          };

const baseMsgCreateBasket: object = { curator: "",name: "",displayName: "",exponent: 0,disableAutoRetire: false,allowPicking: false };
...
fromPartial<I extends Exact<DeepPartial<MsgCreateBasket>, I>>(object: I): MsgCreateBasket {
      const message = { ...baseMsgCreateBasket } as MsgCreateBasket;
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgCreateBasketResponse } as MsgCreateBasketResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromPartial<I extends Exact<DeepPartial<MsgCreateBasketResponse>, I>>(object: I): MsgCreateBasketResponse {
      const message = { ...baseMsgCreateBasketResponse } as MsgCreateBasketResponse;
...
fromPartial<I extends Exact<DeepPartial<MsgAddToBasket>, I>>(object: I): MsgAddToBasket {
      const message = { ...baseMsgAddToBasket } as MsgAddToBasket;
message.owner = object.owner ?? "";
message.basketDenom = object.basketDenom ?? "";
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgAddToBasketResponse } as MsgAddToBasketResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
case 1:
...
fromJSON(object: any): MsgAddToBasketResponse {
      const message = { ...baseMsgAddToBasketResponse } as MsgAddToBasketResponse;
message.amountReceived = (object.amountReceived !== undefined && object.amountReceived !== null)
...
fromPartial<I extends Exact<DeepPartial<MsgAddToBasketResponse>, I>>(object: I): MsgAddToBasketResponse {
      const message = { ...baseMsgAddToBasketResponse } as MsgAddToBasketResponse;
...
const baseMsgTakeFromBasket: object = { owner: "",basketDenom: "",amount: "",retirementLocation: "" };
...
fromPartial<I extends Exact<DeepPartial<MsgTakeFromBasket>, I>>(object: I): MsgTakeFromBasket {
      const message = { ...baseMsgTakeFromBasket } as MsgTakeFromBasket;
message.owner = object.owner ?? "";
message.basketDenom = object.basketDenom ?? "";
message.amount = object.amount ?? "";
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgTakeFromBasketResponse } as MsgTakeFromBasketResponse;
message.credits = [];
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
fromPartial<I extends Exact<DeepPartial<MsgTakeFromBasketResponse>, I>>(object: I): MsgTakeFromBasketResponse {
      const message = { ...baseMsgTakeFromBasketResponse } as MsgTakeFromBasketResponse;
message.credits = object.credits?.map((e) => BasketCredit.fromPartial(e)) || [];
return message;
}
...
const baseMsgPickFromBasket: object = { owner: "",basketDenom: "",retirementLocation: "" };
...
fromPartial<I extends Exact<DeepPartial<MsgPickFromBasket>, I>>(object: I): MsgPickFromBasket {
      const message = { ...baseMsgPickFromBasket } as MsgPickFromBasket;
message.owner = object.owner ?? "";
message.basketDenom = object.basketDenom ?? "";
message.credits = object.credits?.map((e) => BasketCredit.fromPartial(e)) || [];
...
decode(
      ...
      const reader = input instanceof Reader ? input : new Reader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = { ...baseMsgPickFromBasketResponse } as MsgPickFromBasketResponse;
while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
default:
...
fromPartial<I extends Exact<DeepPartial<MsgPickFromBasketResponse>, I>>(_: I): MsgPickFromBasketResponse {
      const message = { ...baseMsgPickFromBasketResponse } as MsgPickFromBasketResponse;
return message;
}
          };
 ...
 *   so on.
 */
TakeFromBasket(request: MsgTakeFromBasket): Promise<MsgTakeFromBasketResponse>;
/**
 ...
 */
PickFromBasket(request: MsgPickFromBasket): Promise<MsgPickFromBasketResponse>;
}

export class MsgClientImpl implements Msg {private readonly rpc: Rpc;constructor(rpc: Rpc) {this.rpc = rpc;this.CreateClass = this.CreateClass.bind(this);this.CreateProject = this.CreateProject.bind(this);this.CreateBatch = this.CreateBatch.bind(this);this.Send = this.Send.bind(this);this.Retire = this.Retire.bind(this);this.Cancel = this.Cancel.bind(this);this.UpdateClassAdmin = this.UpdateClassAdmin.bind(this);this.UpdateClassIssuers = this.UpdateClassIssuers.bind(this);this.UpdateClassMetadata = this.UpdateClassMetadata.bind(this);this.Sell = this.Sell.bind(this);this.UpdateSellOrders = this.UpdateSellOrders.bind(this);this.Buy = this.Buy.bind(this);this.AllowAskDenom = this.AllowAskDenom.bind(this);this.CreateBasket = this.CreateBasket.bind(this);this.AddToBasket = this.AddToBasket.bind(this);this.TakeFromBasket = this.TakeFromBasket.bind(this);this.PickFromBasket = this.PickFromBasket.bind(this);}
    CreateClass(
      request: MsgCreateClass
    ...
    UpdateClassAdmin(
      ...
      return promise.then(data => MsgUpdateClassAdminResponse.decode(new Reader(data)));
    }
    ...
    UpdateClassIssuers(
      ...
      return promise.then(data => MsgUpdateClassIssuersResponse.decode(new Reader(data)));
    }
    ...
    UpdateClassMetadata(
      ...
      return promise.then(data => MsgUpdateClassMetadataResponse.decode(new Reader(data)));
    }
    ...
    Sell(
      ...
      return promise.then(data => MsgSellResponse.decode(new Reader(data)));
    }
    ...
    UpdateSellOrders(
      ...
      return promise.then(data => MsgUpdateSellOrdersResponse.decode(new Reader(data)));
    }
    ...
    AllowAskDenom(
      ...
      return promise.then(data => MsgAllowAskDenomResponse.decode(new Reader(data)));
    }
  
    CreateBasket(
      request: MsgCreateBasket
    ): Promise<MsgCreateBasketResponse> {
      ...
      return promise.then(data => MsgCreateBasketResponse.decode(new Reader(data)));
    }
  
    AddToBasket(
      request: MsgAddToBasket
    ): Promise<MsgAddToBasketResponse> {
      ...
      return promise.then(data => MsgAddToBasketResponse.decode(new Reader(data)));
    }
    ...
    TakeFromBasket(
      ...
      return promise.then(data => MsgTakeFromBasketResponse.decode(new Reader(data)));
    }
    ...
    PickFromBasket(
      ...
      return promise.then(data => MsgPickFromBasketResponse.decode(new Reader(data)));
    }
  }
