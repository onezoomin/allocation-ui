...
import { Params, ClassInfo, BatchInfo, CreditTypeSeq, ProjectInfo } from '../../../regen/ecocredit/v1alpha2/types';
...
for (const v of message.projectInfo) {
            ProjectInfo.encode(v!, writer.uint32(58).fork()).ldelim();
          }
return writer;
},
...
message.params = (object.params !== undefined && object.params !== null)
          ...
          : undefined;
message.classInfo = (object.classInfo ?? []).map((e: any) => ClassInfo.fromJSON(e));
message.batchInfo = (object.batchInfo ?? []).map((e: any) => BatchInfo.fromJSON(e));
message.sequences = (object.sequences ?? []).map((e: any) => CreditTypeSeq.fromJSON(e));
message.balances = (object.balances ?? []).map((e: any) => Balance.fromJSON(e));
message.supplies = (object.supplies ?? []).map((e: any) => Supply.fromJSON(e));
message.projectInfo = (object.projectInfo ?? []).map((e: any) => ProjectInfo.fromJSON(e));
return message
},
...
if (message.projectInfo) {
          obj.projectInfo = message.projectInfo.map(e => e ? ProjectInfo.toJSON(e) : undefined);
        } else {
          obj.projectInfo = [];
        }
return obj;
...
message.projectInfo = object.projectInfo?.map((e) => ProjectInfo.fromPartial(e)) || [];
return message;
}
          };

const baseBalance: object = { address: "",batchDenom: "",tradableBalance: "",retiredBalance: "" };
...
message.batchDenom = (object.batchDenom !== undefined && object.batchDenom !== null)
          ...
          : "";
message.tradableBalance = (object.tradableBalance !== undefined && object.tradableBalance !== null)
          ? String(object.tradableBalance)
          : "";
message.retiredBalance = (object.retiredBalance !== undefined && object.retiredBalance !== null)
...
const baseSupply: object = { batchDenom: "",tradableSupply: "",retiredSupply: "" };
