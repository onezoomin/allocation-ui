...
export const GenesisState = {
			...
			switch (tag >>> 3) {
				...
				case 6:
					message.supplies.push(
						Supply.decode(reader, reader.uint32())
					);
					break;
				case 7:
					message.projectInfo.push(
	...
	fromJSON(object: any): GenesisState {
		...
		message.params =
			object.params !== undefined && object.params !== null
				...
				: undefined;
		message.classInfo = (object.classInfo ?? []).map((e: any) =>
			ClassInfo.fromJSON(e)
		);
		message.batchInfo = (object.batchInfo ?? []).map((e: any) =>
			BatchInfo.fromJSON(e)
		);
		message.sequences = (object.sequences ?? []).map((e: any) =>
			CreditTypeSeq.fromJSON(e)
		);
		message.balances = (object.balances ?? []).map((e: any) =>
			Balance.fromJSON(e)
		);
		message.supplies = (object.supplies ?? []).map((e: any) =>
			Supply.fromJSON(e)
		);
		message.projectInfo = (object.projectInfo ?? []).map((e: any) =>
	...
	fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
		...
		message.supplies =
			object.supplies?.map((e) => Supply.fromPartial(e)) || [];
		message.projectInfo =
	...
	fromJSON(object: any): Balance {
		...
		message.batchDenom =
			object.batchDenom !== undefined && object.batchDenom !== null
				...
				: '';
		message.tradableBalance =
			object.tradableBalance !== undefined &&
			object.tradableBalance !== null
				? String(object.tradableBalance)
				: '';
		message.retiredBalance =
			object.retiredBalance !== undefined &&
			object.retiredBalance !== null
