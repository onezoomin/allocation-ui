...
switch (object) {
case MediaType.MEDIA_TYPE_UNSPECIFIED: return "MEDIA_TYPE_UNSPECIFIED";
case MediaType.MEDIA_TYPE_TEXT_PLAIN: return "MEDIA_TYPE_TEXT_PLAIN";
case MediaType.MEDIA_TYPE_JSON: return "MEDIA_TYPE_JSON";
case MediaType.MEDIA_TYPE_CSV: return "MEDIA_TYPE_CSV";
case MediaType.MEDIA_TYPE_XML: return "MEDIA_TYPE_XML";
case MediaType.MEDIA_TYPE_PDF: return "MEDIA_TYPE_PDF";
case MediaType.MEDIA_TYPE_TIFF: return "MEDIA_TYPE_TIFF";
case MediaType.MEDIA_TYPE_JPG: return "MEDIA_TYPE_JPG";
case MediaType.MEDIA_TYPE_PNG: return "MEDIA_TYPE_PNG";
case MediaType.MEDIA_TYPE_SVG: return "MEDIA_TYPE_SVG";
case MediaType.MEDIA_TYPE_WEBP: return "MEDIA_TYPE_WEBP";
case MediaType.MEDIA_TYPE_AVIF: return "MEDIA_TYPE_AVIF";
case MediaType.MEDIA_TYPE_GIF: return "MEDIA_TYPE_GIF";
case MediaType.MEDIA_TYPE_APNG: return "MEDIA_TYPE_APNG";
case MediaType.MEDIA_TYPE_MPEG: return "MEDIA_TYPE_MPEG";
case MediaType.MEDIA_TYPE_MP4: return "MEDIA_TYPE_MP4";
case MediaType.MEDIA_TYPE_WEBM: return "MEDIA_TYPE_WEBM";
case MediaType.MEDIA_TYPE_OGG: return "MEDIA_TYPE_OGG";
...
switch (object) {
case GraphCanonicalizationAlgorithm.GRAPH_CANONICALIZATION_ALGORITHM_UNSPECIFIED: return "GRAPH_CANONICALIZATION_ALGORITHM_UNSPECIFIED";
case GraphCanonicalizationAlgorithm.GRAPH_CANONICALIZATION_ALGORITHM_URDNA2015: return "GRAPH_CANONICALIZATION_ALGORITHM_URDNA2015";
default: return "UNKNOWN";
}
}
...
switch (object) {
case GraphMerkleTree.GRAPH_MERKLE_TREE_NONE_UNSPECIFIED: return "GRAPH_MERKLE_TREE_NONE_UNSPECIFIED";
default: return "UNKNOWN";
}
}
...
message.hash = (object.hash !== undefined && object.hash !== null)
          ...
          : new Uint8Array();
message.digestAlgorithm = (object.digestAlgorithm !== undefined && object.digestAlgorithm !== null)
          ? digestAlgorithmFromJSON(object.digestAlgorithm)
          : 0;
message.mediaType = (object.mediaType !== undefined && object.mediaType !== null)
...
const baseContentHash_Graph: object = { digestAlgorithm: 0,canonicalizationAlgorithm: 0,merkleTree: 0 };
...
message.digestAlgorithm = (object.digestAlgorithm !== undefined && object.digestAlgorithm !== null)
          ? digestAlgorithmFromJSON(object.digestAlgorithm)
          : 0;
message.canonicalizationAlgorithm = (object.canonicalizationAlgorithm !== undefined && object.canonicalizationAlgorithm !== null)
...
fromPartial<I extends Exact<DeepPartial<SignerEntry>, I>>(object: I): SignerEntry {
      const message = { ...baseSignerEntry } as SignerEntry;
