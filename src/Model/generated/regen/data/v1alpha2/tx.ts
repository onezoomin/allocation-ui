...
import { ContentHash, ContentHash_Graph } from '../../../regen/data/v1alpha2/types';
...
fromPartial<I extends Exact<DeepPartial<MsgAnchorData>, I>>(object: I): MsgAnchorData {
      const message = { ...baseMsgAnchorData } as MsgAnchorData;
...
const baseMsgAnchorDataResponse: object = { iri: "" };
...
fromPartial<I extends Exact<DeepPartial<MsgAnchorDataResponse>, I>>(object: I): MsgAnchorDataResponse {
      const message = { ...baseMsgAnchorDataResponse } as MsgAnchorDataResponse;
...
fromPartial<I extends Exact<DeepPartial<MsgSignData>, I>>(object: I): MsgSignData {
      const message = { ...baseMsgSignData } as MsgSignData;
...
fromPartial<I extends Exact<DeepPartial<MsgSignDataResponse>, I>>(_: I): MsgSignDataResponse {
      const message = { ...baseMsgSignDataResponse } as MsgSignDataResponse;
return message;
}
          };
...
export class MsgClientImpl implements Msg {private readonly rpc: Rpc;constructor(rpc: Rpc) {this.rpc = rpc;this.AnchorData = this.AnchorData.bind(this);this.SignData = this.SignData.bind(this);}
    AnchorData(
      request: MsgAnchorData
